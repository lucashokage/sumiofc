 ...
 * @returns {boolean} - true si el valor es nulo o indefinido, false en caso contrario
 */
...
/**
 * Función para crear un socket de WhatsApp
 * @param {Object} connectionOptions - Opciones de conexión
    ...
    sendFile: {
      ...
      async value(jid, path, filename = "", caption = "", quoted, ptt = false, options = {}) {
        try {
          ...
          // Check if pathFile exists before using fs.statSync
          let fileSize = 0
...
END:VCARD
  ...
  // Definir loadMessage como método en el objeto conn directamente
  // en lugar de intentar asignarlo como propiedad de solo lectura
