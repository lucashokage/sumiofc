...
return conn.reply(m.chat, `${global.emoji3} Debés esperar. ${msToTime(timeLeft)} antes de aventurarte de nuevo.`, m);
}
let kingdoms = [
'Reino de Eldoria',
'Reino de Drakonia',
...
await conn.sendFile(m.chat, img, 'yuki.jpg', info, global.fkontak);
}
