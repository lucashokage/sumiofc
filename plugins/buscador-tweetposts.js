...
let handler = async (m, { conn, text }) => {
  if (!text) { 
    return conn.reply(m.chat, `${emoji} Por favor, ingresa el texto de lo que quieres buscar en Twitter.`, m); 
  }

  await m.react(rwait);
  conn.reply(m.chat, `${emoji} Descargando su video, espere un momento...`, m);
